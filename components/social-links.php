...
<ul class="social-links">
	...
	<li class="social-twitter"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Twitter'; ?>"
	...
	<li class="social-github"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Github'; ?>"
	...
	<li class="social-linkedin"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on LinkedIn'; ?>"
	...
	<li class="social-wechat"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on WeChat'; ?>"
	...
	<li class="social-youtube"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on YouTube'; ?>"
	...
	<li class="social-flickr"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Flickr'; ?>"
	...
	<li class="social-facebook"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Facebook'; ?>"
	...
	<li class="social-meetup"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Meetup'; ?>"
	...
	<li class="social-twitch"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' on Twitch'; ?>"
	...
	<li class="social-slack"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' Slack'; ?>"
			href="<?php echo esc_url( $site_options['social_slack'] ); ?>"><?php LF_Utils::get_svg( 'social/slack.svg' ); ?></a></li>
	<?php endif; ?>

	<li class="social-discord"><a target="_blank" title="<?php echo esc_html( get_bloginfo( 'name' ) ) . ' Discord'; ?>"
			href="https://discord.profian.com/"><?php LF_Utils::get_svg( 'social/discord.svg' ); ?></a></li>
</ul>
